...
# CLI / REST bearer tokens carry a fixed prefix so they are recognisable in
# logs and shell history as a recon credential (and greppable for rotation).
API_TOKEN_PREFIX = "recon_"
